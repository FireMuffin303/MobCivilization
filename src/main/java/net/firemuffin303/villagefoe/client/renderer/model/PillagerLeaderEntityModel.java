package net.firemuffin303.villagefoe.client.renderer.model;
...
public class PillagerLeaderEntityModel extends GeoModel<PillagerQuestEntity> {
    ...
    public Identifier getModelResource(PillagerQuestEntity pillagerQuestEntity) {
        return new Identifier(VillageFoe.MOD_ID,"geo/pillager/pillager_leader.geo.json");
    }

    @Override
    public Identifier getTextureResource(PillagerQuestEntity pillagerQuestEntity) {
        return new Identifier(VillageFoe.MOD_ID,"textures/entity/pillager_leader/pillager_leader.png");
    }
    ...
    private void crossBowAnimation(PillagerQuestEntity animatable, EntityModelData entityModelData , CoreGeoBone leftArm, CoreGeoBone rightArm){
        //Y = yaw | X = pitch
