package net.firemuffin303.villagefoe.common.event;
...
import net.firemuffin303.villagefoe.mixin.ActiveTargetGoalAccessor;
import net.firemuffin303.villagefoe.mixin.FleeEntityGoalAccessor;
import net.firemuffin303.villagefoe.mixin.MobAccessor;
