package net.firemuffin303.villagefoe.datagen.structure;
...
import net.firemuffin303.villagefoe.datagen.ModDataGen;
...
public class StructureData {
    ...
    public static final RegistryKey<Structure> PIGLIN_VILLAGE = RegistryKey.of(RegistryKeys.STRUCTURE,new Identifier(VillageFoe.MOD_ID,"piglin_village"));
    public static final RegistryKey<StructureSet> NETHER_VILLAGE = RegistryKey.of(RegistryKeys.STRUCTURE_SET,new Identifier(VillageFoe.MOD_ID,"nether_village"));

    //--- Configured Feature
    public static final RegistryKey<ConfiguredFeature<?,?>> PILE_NETHER_WART_BLOCK_CONFIGURED = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE,new Identifier(VillageFoe.MOD_ID,"pile_nether_wart_block"));
    public static final RegistryKey<ConfiguredFeature<?,?>> PILE_WARPED_WART_BLOCK_CONFIGURED = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE,new Identifier(VillageFoe.MOD_ID,"pile_warped_wart_block"));
    public static final RegistryKey<ConfiguredFeature<?,?>> PILE_SOUL_SAND_CONFIGURED = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE,new Identifier(VillageFoe.MOD_ID,"pile_soul_sand_block"));
    public static final RegistryKey<ConfiguredFeature<?,?>> PILE_SOUL_SOIL_CONFIGURED = RegistryKey.of(RegistryKeys.CONFIGURED_FEATURE,new Identifier(VillageFoe.MOD_ID,"pile_soul_soil_block"));

    //--- Placed Feature ---
    public static final RegistryKey<PlacedFeature> PILE_NETHER_WART_BLOCK_PLACED = RegistryKey.of(RegistryKeys.PLACED_FEATURE,new Identifier(VillageFoe.MOD_ID,"pile_nether_wart_block"));
    public static final RegistryKey<PlacedFeature> PILE_WARPED_WART_BLOCK_PLACED = RegistryKey.of(RegistryKeys.PLACED_FEATURE,new Identifier(VillageFoe.MOD_ID,"pile_warped_wart_block"));
    public static final RegistryKey<PlacedFeature> PILE_SOUL_SAND_PLACED = RegistryKey.of(RegistryKeys.PLACED_FEATURE,new Identifier(VillageFoe.MOD_ID,"pile_soul_sand_block"));
    public static final RegistryKey<PlacedFeature> PILE_SOUL_SOIL_PLACED = RegistryKey.of(RegistryKeys.PLACED_FEATURE,new Identifier(VillageFoe.MOD_ID,"pile_soul_soil_block"));

    //--Template--
    public static final RegistryKey<StructurePool> PIGLIN_TOWN_CENTER = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/piglin/town_center"));
    public static final RegistryKey<StructurePool> PIGLIN_VILLAGE_HOUSES = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/piglin/houses"));
    public static final RegistryKey<StructurePool> PIGLIN_VILLAGE_DECOR = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/piglin/decor"));
    public static final RegistryKey<StructurePool> PIGLIN_VILLAGE_STREETS = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/piglin/streets"));
    public static final RegistryKey<StructurePool> PIGLIN_VILLAGE_TERMINATOR = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/piglin/terminators"));
    public static final RegistryKey<StructurePool> PIGLIN_VILLAGE_UNEMPLOYED = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/piglin/entity/unemployed"));
    public static final RegistryKey<StructurePool> PIGLIN_VILLAGE_LEADER = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/piglin/entity/leader"));
    public static final RegistryKey<StructurePool> PIGLIN_VILLAGE_ANIMAL = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/piglin/entity/animals"));
    ...
    public static Function<StructurePool.Projection, LegacySinglePoolElement> ofProcessedLegacySingle(String id, RegistryEntry<StructureProcessorList> processorListEntry) {
        return (projection) -> new ModLegacySinglePoolElement(Either.left(new Identifier(VillageFoe.MOD_ID,id)), processorListEntry, projection);
    }
