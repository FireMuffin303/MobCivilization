...
public class FortressStructureData {
    public static final RegistryKey<StructurePool> FORTRESS_WORKER = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"fortress/worker"));
    public static final RegistryKey<StructurePool> FORTRESS_LEADER_WORKER = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"fortress/leader_worker"));
