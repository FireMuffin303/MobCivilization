...
public class PillagerStructureData {
    public static final RegistryKey<Structure> PILLAGE_VILLAGE = RegistryKey.of(RegistryKeys.STRUCTURE,new Identifier(VillageFoe.MOD_ID,"pillage_village"));

    public static final RegistryKey<StructurePool> PILLAGE_VILLAGE_BASE_PLATE = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/pillager_outpost/base_plate"));
    public static final RegistryKey<StructurePool> PILLAGE_VILLAGE_TOWER = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/pillager_outpost/bell_towers"));
    public static final RegistryKey<StructurePool> PILLAGE_VILLAGE_HOUSES = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/pillager_outpost/houses"));
    public static final RegistryKey<StructurePool> PILLAGE_VILLAGE_INDOOR_DECOR = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/pillager_outpost/indoor_decor"));
    public static final RegistryKey<StructurePool> PILLAGE_VILLAGE_DECOR = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/pillager_outpost/decor"));
    public static final RegistryKey<StructurePool> PILLAGE_VILLAGE_STREETS = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/pillager_outpost/streets"));
    public static final RegistryKey<StructurePool> PILLAGE_VILLAGE_TERMINATORS = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/pillager_outpost/terminators"));

    public static final RegistryKey<StructurePool> PILLAGE_VILLAGE_LEADER = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/pillager_outpost/pillager_leader"));
    public static final RegistryKey<StructurePool> PILLAGE_VILLAGE_WORKER = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/pillager_outpost/pillager_worker"));
    public static final RegistryKey<StructurePool> PILLAGE_VILLAGE_PILLAGER = RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(VillageFoe.MOD_ID,"village/pillager_outpost/pillagers"));
