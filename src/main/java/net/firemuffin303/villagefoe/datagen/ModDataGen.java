...
import net.firemuffin303.villagefoe.datagen.integration.QuestDataGen;
...
public class ModDataGen implements DataGeneratorEntrypoint {
    public static final TagKey<Biome> PIGLIN_VILLAGE_HAS_STRUCTURE = TagKey.of(RegistryKeys.BIOME,new Identifier(VillageFoe.MOD_ID,"piglin_village_has_village"));
    @Override
