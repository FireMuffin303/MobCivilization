...
import net.firemuffin303.civilizedmobs.mixin.structures.*;
...
public class CivilizedMobs implements ModInitializer {
    ...
    private static void onServerStarting(MinecraftServer minecraftServer) {
        ...
        if(FabricLoader.getInstance().isModLoaded("betterfortresses")){
            ...
            CivilizedMobs.onYungBetterFortressLoaded(minecraftServer);
        }
    ...
    private static void onYungBetterFortressLoaded(MinecraftServer minecraftServer){
        ...
        RegistryEntry<StructurePool> injectedHallPool = structurePoolRegistryWrapper.getOrThrow(RegistryKey.of(RegistryKeys.TEMPLATE_POOL,new Identifier(CivilizedMobs.MOD_ID,"inject/betterfortresses/halls")));
