package net.firemuffin303.civilizedmobs.common.entity.witherSkelton;
    ...
    public static final Map<VillagerProfession, Map<Integer, List<TradeOffers.Factory>>> WITHER_TRADES = Util.make(Maps.newHashMap(), villagerProfessionMapHashMap -> {
        ...
        villagerProfessionMapHashMap.put(VillagerProfession.MASON,Util.make(Maps.newHashMap(),integerListHashMap -> {
            ...
            integerListHashMap.put(2,List.of(
                    ...
                    new GoldForItemFactory(new ItemStack(Items.BLACKSTONE,16), 1, 12, 1, 0.2F),
                    new GoldForItemFactory(new ItemStack(Items.CHISELED_POLISHED_BLACKSTONE,4), 1, 12, 1, 0.2F)
            ));

            integerListHashMap.put(3,List.of(
                    new ItemForGold(Items.SOUL_SAND,32,16,2),
                    new ItemForGold(Items.SOUL_SOIL,32,16,2),
                    new GoldForItemFactory(new ItemStack(Items.RED_NETHER_BRICKS,16), 8, 12, 1, 0.2F),
                    new GoldForItemFactory(new ItemStack(Items.CHISELED_NETHER_BRICKS,16), 8, 12, 1, 0.2F)
            ));

            integerListHashMap.put(4,List.of(
                    new ItemForGold(Items.QUARTZ,12,16,30),
                    new GoldForItemFactory(new ItemStack(Items.QUARTZ_BLOCK,12),1,12,30,0.2F),
                    new GoldForItemFactory(new ItemStack(Items.QUARTZ_PILLAR,12),1,12,30,0.2F)
            ));
