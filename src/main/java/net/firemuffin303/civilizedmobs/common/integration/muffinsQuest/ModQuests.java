...
public class ModQuests {
    ...
    public static final TagKey<Quest> PILLAGER_QUEST = TagKey.of(ModRegistries.QUEST_KEY,new Identifier(CivilizedMobs.MOD_ID,"pillager_quest"));
    public static final TagKey<Quest> WITHER_QUEST = TagKey.of(ModRegistries.QUEST_KEY,new Identifier(CivilizedMobs.MOD_ID,"wither_quest"));
    ...
    //---------------------
    public static final RegistryKey<Quest> KILL_10_VILLAGER = RegistryKey.of(ModRegistries.QUEST_KEY,new Identifier(CivilizedMobs.MOD_ID,"kill_10_villager"));
    public static final RegistryKey<Quest> KILL_20_VILLAGER = RegistryKey.of(ModRegistries.QUEST_KEY,new Identifier(CivilizedMobs.MOD_ID,"kill_20_villager"));
    public static final RegistryKey<Quest> KILL_30_VILLAGER = RegistryKey.of(ModRegistries.QUEST_KEY,new Identifier(CivilizedMobs.MOD_ID,"kill_30_villager"));

    public static final RegistryKey<Quest> KILL_10_IRON_GOLEM = RegistryKey.of(ModRegistries.QUEST_KEY,new Identifier(CivilizedMobs.MOD_ID,"kill_10_iron_golem"));
    public static final RegistryKey<Quest> KILL_20_IRON_GOLEM = RegistryKey.of(ModRegistries.QUEST_KEY,new Identifier(CivilizedMobs.MOD_ID,"kill_20_iron_golem"));
    public static final RegistryKey<Quest> KILL_30_IRON_GOLEM = RegistryKey.of(ModRegistries.QUEST_KEY,new Identifier(CivilizedMobs.MOD_ID,"kill_30_iron_golem"));


    //---- Wither ----
    public static final RegistryKey<Quest> KILL_10_PIGLIN = RegistryKey.of(ModRegistries.QUEST_KEY,new Identifier(CivilizedMobs.MOD_ID,"kill_10_piglins"));
    public static final RegistryKey<Quest> KILL_20_PIGLIN = RegistryKey.of(ModRegistries.QUEST_KEY,new Identifier(CivilizedMobs.MOD_ID,"kill_20_piglins"));
    public static final RegistryKey<Quest> KILL_30_PIGLIN = RegistryKey.of(ModRegistries.QUEST_KEY,new Identifier(CivilizedMobs.MOD_ID,"kill_30_piglins"));
    ...
    public static void bootstrap(Registerable<Quest> questRegisterable){
        ...
        questRegisterable.register(KILL_10_VILLAGER,new Quest(new Quest.Definition(List.of(new ItemStack(Items.EMERALD,32)),20),"Kill 10 Villagers").setRarity(Quest.QuestRarity.COMMON)
                .addQuest(ModQuestTypes.KILL_ENTITY_DATA,new KillEntityQuestData(new KillEntityQuestData.EntityRequirementEntry(EntityType.VILLAGER,10))));
        ...
        questRegisterable.register(KILL_20_VILLAGER,new Quest(new Quest.Definition(List.of(new ItemStack(Items.EMERALD,64),new ItemStack(Items.EMERALD,32)),20),"Kill 20 Villagers").setRarity(Quest.QuestRarity.COMMON)
                .addQuest(ModQuestTypes.KILL_ENTITY_DATA,new KillEntityQuestData(new KillEntityQuestData.EntityRequirementEntry(EntityType.VILLAGER,20))));
        ...
        questRegisterable.register(KILL_30_VILLAGER,new Quest(new Quest.Definition(List.of(new ItemStack(Items.EMERALD,64),new ItemStack(Items.EMERALD,32), Raid.getOminousBanner(), EnchantedBookItem.forEnchantment(new EnchantmentLevelEntry(Enchantments.MENDING,1))),20),"Kill 30 Villagers").setRarity(Quest.QuestRarity.RARE)
                .addQuest(ModQuestTypes.KILL_ENTITY_DATA,new KillEntityQuestData(new KillEntityQuestData.EntityRequirementEntry(EntityType.VILLAGER,30))));
        ...
        questRegisterable.register(KILL_10_IRON_GOLEM,new Quest(new Quest.Definition(List.of(new ItemStack(Items.EMERALD,32)),50),"Kill 10 Iron Golems").setRarity(Quest.QuestRarity.COMMON)
                .addQuest(ModQuestTypes.KILL_ENTITY_DATA,new KillEntityQuestData(new KillEntityQuestData.EntityRequirementEntry(EntityType.IRON_GOLEM,10))));
        ...
        questRegisterable.register(KILL_20_IRON_GOLEM,new Quest(new Quest.Definition(List.of(new ItemStack(Items.EMERALD,64),new ItemStack(Items.EMERALD,32),Raid.getOminousBanner(),new ItemStack(Items.DIAMOND,12)),80),"Kill 20 Iron Golems").setRarity(Quest.QuestRarity.UNCOMMON)
                .addQuest(ModQuestTypes.KILL_ENTITY_DATA,new KillEntityQuestData(new KillEntityQuestData.EntityRequirementEntry(EntityType.IRON_GOLEM,20))));
        ...
        questRegisterable.register(KILL_30_IRON_GOLEM,new Quest(new Quest.Definition(List.of(new ItemStack(Items.EMERALD,64),new ItemStack(Items.EMERALD,32), Raid.getOminousBanner(), new ItemStack(Items.TOTEM_OF_UNDYING)),120),"Kill 30 Iron Golems").setRarity(Quest.QuestRarity.RARE)
                .addQuest(ModQuestTypes.KILL_ENTITY_DATA,new KillEntityQuestData(new KillEntityQuestData.EntityRequirementEntry(EntityType.IRON_GOLEM,30))));
        ...
        questRegisterable.register(KILL_10_PIGLIN,new Quest(new Quest.Definition(List.of(new ItemStack(Items.GOLD_BLOCK,16)),50),"Kill 10 Piglins").setRarity(Quest.QuestRarity.COMMON)
                .addQuest(ModQuestTypes.KILL_ENTITY_DATA,new KillEntityQuestData(new KillEntityQuestData.EntityRequirementEntry(EntityType.PIGLIN,10))));
        ...
        questRegisterable.register(KILL_20_PIGLIN,new Quest(new Quest.Definition(List.of(new ItemStack(Items.GOLD_BLOCK,20),new ItemStack(Items.WITHER_ROSE,8)),60),"Kill 20 Piglins").setRarity(Quest.QuestRarity.UNCOMMON)
                .addQuest(ModQuestTypes.KILL_ENTITY_DATA,new KillEntityQuestData(new KillEntityQuestData.EntityRequirementEntry(EntityType.PIGLIN,20))));
        ...
        questRegisterable.register(KILL_30_PIGLIN,new Quest(new Quest.Definition(List.of(new ItemStack(Items.GOLD_BLOCK,24),new ItemStack(Items.PIGLIN_HEAD,1), new ItemStack(Items.WITHER_ROSE,16)),80),"Kill 30 Piglins").setRarity(Quest.QuestRarity.UNCOMMON)
                .addQuest(ModQuestTypes.KILL_ENTITY_DATA,new KillEntityQuestData(new KillEntityQuestData.EntityRequirementEntry(EntityType.PIGLIN,30))));
