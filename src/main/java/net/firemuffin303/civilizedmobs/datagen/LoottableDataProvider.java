...
public class LoottableDataProvider {
    ...
    public static final Identifier PIGLIN_WORKER = new Identifier(CivilizedMobs.MOD_ID,"entities/piglin_worker");
    public static final Identifier PIGLIN_LEADER = new Identifier(CivilizedMobs.MOD_ID,"entities/piglin_leader");
    public static final Identifier PILLAGER_WORKER = new Identifier(CivilizedMobs.MOD_ID,"entities/pillager_worker");
    public static final Identifier PILLAGER_LEADER = new Identifier(CivilizedMobs.MOD_ID,"entities/pillager_leader");
    public static final Identifier WITHER_SKELETON_WORKER = new Identifier(CivilizedMobs.MOD_ID,"entities/wither_skeleton_worker");
    public static final Identifier WITHER_SKELETON_LEADER = new Identifier(CivilizedMobs.MOD_ID,"entities/wither_skeleton_leader");
