...
import net.firemuffin303.civilizedmobs.client.renderer.CivilPiglinRenderer;
...
public class CivilizedMobsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        EntityRendererRegistry.register(ModEntityType.CIVIL_PIGLIN, CivilPiglinRenderer::new);
